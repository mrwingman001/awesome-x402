...
- [LogicNodes](https://logicnodes.io) - Live A2A agent marketplace with 242 deterministic AI workers payable per-call in USDC on Base. No signup — agents discover via Bazaar, pay x402, get verified results with SHA-256 trust hashes. Tiers: $0.05 / $0.15 / $0.50 USDC. ([npm MCP bridge](https://www.npmjs.com/package/logicnodes-mcp-bridge): `npx logicnodes-mcp-bridge`) | ([Bazaar](https://api.cdp.coinbase.com/platform/v2/x402/discovery/merchant?payTo=0xc174A7C8088BF271399CD3E9f88c20D37CAb967D)) | ([Agent Guide](https://logicnodes.io/agent-guide))
